...
├── vocab.txt           # GPT-2 vocabulary (generated by export_weights.py)
└── README.md
```

> **Note:** `gpt2_tiny.bin` (~1.4 GB) and `engine.exe` are excluded from the repo. See setup instructions below.
...
Input text: The future of AI
Tokens: [The -> 464] [future -> 2003] [of -> 286] [AI -> 9552]
Generating:  is going to be very exciting and it will
```
